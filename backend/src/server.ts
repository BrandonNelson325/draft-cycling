...
const skipRateLimitPaths = ['/api/subscription/redeem', '/api/subscription/checkout', '/api/subscription/status', '/api/beta/activate', '/api/subscription/webhook', '/api/auth/profile', '/api/auth/refresh'];
